# -*- coding: utf-8 -*-
"""
Created on Mon May 29 19:36:28 2023

@author: Micah Briney

Creates an active delivery and adds sends it to the backend using the 
addActiveDelivery api.

Usage: 
    1. Enter in the number of deliveries that you want to create.
    2. Enter in the state or US territory you want the delivery('s) pickup and 
       destination. Input "all" to randomly choose a pickup and desitination 
       state/territory. Typos will default to all
    3. Wait till program finishes
"""
...
def generateRealRandomAddress(geocoder, region_bounding_boxes, input_state):
    ...
    while any(value is None for value in address_components.values()):
        ...
        # print("State parameter: ", input_state) # for testing
        ...
        # print("Region selected:", region) # For testing
        ...
        # ("California",           42.000, 32.032, -124.025, -114.007),
        # Generate random latitude and longitude within California
        # latitude = random.uniform(42, 32.032)
        # longitude = random.uniform(-124.025, -114.007)
        
        # ("Tennessee",            36.041, 34.058, -90.019,  -81.038),
        # Generate random latitude and longitude within Tennessee 
        # latitude = random.uniform(36.041, 34.058)
        # longitude = random.uniform(-90.019, -81.038)
...
def getUserInput():
    ...
    if user_state_input in valid_inputs:
        ...
        print(f"Creating {user_count_input} delivers in {user_state_input}...")
    elif user_state_input == "All":
        # User entered 'all'
        # Perform your logic for 'all' here
        print(f"Creating deliveries in {user_count_input} random US states and territory...")
    else:
    ...
    return user_state_input, user_count_input
